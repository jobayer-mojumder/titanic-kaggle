...
X = train_data.drop(
    ["Survived", "PassengerId", "Name", "Ticket", "Cabin", "Age"],
    axis=1,
)
...
numerical_features = ["SibSp", "Parch", "Fare", "Sex"]
categorical_features = ["Pclass", "Embarked", "AgeGroup"]
...
output.to_csv("submission_xgb_agegroup.csv", index=False)
