...
def run_rf(feature_nums):
    ...
    print(f"🌲 Running Random Forest with: {SELECTED_FEATURES or 'Baseline only'}")
    ...
    out_file = f"submissions/3_Random-Forest/submission_rf_{suffix}.csv"
...
if __name__ == "__main__":
    run_rf([3, 6, 8])  # Use [] for baseline, or [2, 6, 11] for combo
