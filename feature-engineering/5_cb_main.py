...
def run_catboost(feature_nums):
    ...
    print(f"🐈 Running CatBoost with: {SELECTED_FEATURES or 'Baseline only'}")
    ...
    out_file = f"submissions/5_CatBoost/submission_catboost_{suffix}.csv"
...
if __name__ == "__main__":
    run_catboost([9, 11])  # Baseline run — same logic as your original CatBoost script
