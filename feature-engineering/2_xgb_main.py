...
from modules.combination import GENERAL_FEATURE_COMBINATIONS, XGB_COMBINATIONS
...
def run_xgb_combinations():
    for combination in XGB_COMBINATIONS:
        run_xgboost(combination)
